...
const Modal = ({
  ...
  useEffect(() => {
    if (selectedTodo) {
      ...
      fillValues(
        selectedTodo,
        (forms as unknown as HTMLFormElement).elements,
        setTitle,
        setDay,
        setMonth,
        setYear,
  ...
  const handleSubmit = async (e: React.SyntheticEvent<HTMLElement>) => {
    ...
    if (selectedTodo) {
      try {
        ...
        const editedTodo = await editTodo(selectedTodo.id, {
          title,
          day,
          month,
          year,
        ...
        const allTodosEdited = allTodos.map((todo) =>
  ...
  return (
    modalStatus && (
      <>
        <div
          onClick={() => exitModalFunction({ setModalStatus, setSelectedTodo })}
          className="modal"
          id="modal_layer"
        ></div>
            ...
            <fieldset>
              <ul>
                ...
                <li>
                  ...
                  <div className="date">
                    <select
                      onChange={(e) => handleDayChange(setDay, e.target.value)}
                      id="due_day"
                      name="due_day"
                    >
                    ...
                    <select
                      onChange={(e) =>
                        handleMonthChange(setMonth, e.target.value)
                      }
                      id="due_month"
                      name="due_month"
                    >
                    ...
                    <select
                      onChange={(e) =>
                        handleYearChange(setYear, e.target.value)
                      }
                      id="due_year"
                      name="due_year"
                    >
